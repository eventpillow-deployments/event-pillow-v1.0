            ...
            <div className="grid sm:grid-cols-3 sm:grid-rows-1 sm:gap-x-6 gap-y-6">
                <div>
                    ...
                    <div className="flex flex-col gap-y-3 mt-4">
                        ...
                        <Link className="flex gap-x-2 dark:text-slate-300 text-slate-900" href="https://www.linkedin.com/in/sahilkazi01/" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" stroke-linecap="round" stroke-linejoin="round" className="feather feather-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>                           
                            <p>@SahilKazi</p>
                        </Link>
                ...
                <div className="">
                    ...
                    <p className="text-base mb-6 sm:mb-8 sm:w-10/12 dark:text-slate-300 text-slate-900">After having a exit from WolveElectronics this is my second try at building something that I would love to see being used and make the lives of freelance photographers and studios a little easier.</p>
                    <p className="mb-4 text-lgf font-semibold text-sky-500">I Invite you to become a part of Event Pillow.</p>
                    <div className="mt-6 sm:mt-auto flex items-center justify-between gap-x-6">
                        <Link
                            href="/#join-waitlist"
                            className="rounded-md bg-sky-500 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-pointer bg-gradient-to-r from-cyan-400 to-blue-600 via-purple-500 hover:from-blue-600 hover:to-cyan-400 animate-gradient-x"
