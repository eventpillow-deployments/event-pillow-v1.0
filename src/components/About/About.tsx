    ...
    return (
        <section className="relative px-6 lg:px-8 py-8 sm:py-16 min-h-full flex flex-col">
            ...
            <div className="grid sm:grid-cols-3 sm:grid-rows-1 sm:gap-x-6 gap-y-6">
                <div>
                    <img className="sm:row-span-2" src="https://i.ibb.co/xjbR8M1/Whats-App-Image-2023-02-26-at-3-43-59-PM.jpg" alt="founders picture" />
                    <div className="flex flex-col gap-y-3 mt-4">
                        <Link className="flex gap-x-2 dark:text-slate-300 text-slate-900" href="https://www.youtube.com/@EkMusafirgops" target="_blank">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" className="feather feather-youtube"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"/><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"/></svg>
                            <p>@EkMusafir</p>
                        </Link>
                        <Link className="flex gap-x-2 items-center dark:text-slate-300 text-slate-900" href="tel:+918587001422" target="_blank">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" className="feather feather-phone-call"><path d="M15.05 5A5 5 0 0 1 19 8.95M15.05 1A9 9 0 0 1 23 8.94m-1 7.98v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                            <p>+91 85870 01422</p>
                        </Link>
                    </div>
                </div>
